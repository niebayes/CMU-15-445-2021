...
/// @bayes: terminal character: the null terminal character to terminate a string, i.e. '\0'.
...
TEST(BufferPoolManagerInstanceTest, BinaryDataTest) {
  ...
  /// @bayes: 0: min value generated by the random engine.
  ...
  /// @bayes: strcmp will stop comparing after finding a null terminate char, while memcmp will not.
