...
TEST(LockManagerTest, BasicTest0) { BasicTest0(); }
...
TEST(LockManagerTest, TwoPLTest0) { TwoPLTest0(); }
...
TEST(LockManagerTest, UpgradeLockTest0) { UpgradeTest0(); }

void WoundWaitBasicTest0() {
  LockManager lock_mgr{};
  TransactionManager txn_mgr{&lock_mgr};
  RID rid{0, 0};
...
TEST(LockManagerTest, WoundWaitBasicTest0) { WoundWaitBasicTest0(); }
